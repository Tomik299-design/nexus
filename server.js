...
const CHANGELOG = [
  {
    ...
    date: '2026-03-24',
    items: [
      { type: 'new',  text: 'Voice calls via WebSocket relay — works everywhere' },
      { type: 'new',  text: 'Noise Gate — filters breathing & background noise' },
      { type: 'new',  text: 'Mic & output volume control in Audio settings' },
      { type: 'new',  text: 'Mic test with live level meter' },
      { type: 'new',  text: 'Drag & drop members between voice channels' },
      { type: 'new',  text: 'Voice channel text chat (💬 button in voice room)' },
      { type: 'new',  text: 'Rejoin voice channel automatically after page refresh' },
      { type: 'new',  text: 'Language switcher — CS 🇨🇿 / EN 🇺🇸' },
      { type: 'new',  text: 'Audio settings tab in profile' },
      { type: 'new',  text: 'Persistent offline members — visible after server restart' },
      { type: 'new',  text: 'Permanent bans saved to disk — survive server restarts' },
      { type: 'new',  text: 'Ban & kick works on offline members too' },
      { type: 'new',  text: 'DM list in sidebar — see all conversations' },
      { type: 'new',  text: 'Right-click DM messages — delete & copy' },
      { type: 'new',  text: 'Pin & delete messages in DM' },
      { type: 'new',  text: '@mention picker — type @ to tag someone' },
      { type: 'new',  text: 'Channel permissions — restrict who can write' },
      { type: 'new',  text: 'Support & Ideas button — send feedback via email' },
      { type: 'new',  text: 'Loading screen on every deploy with changelog' },
      { type: 'fix',  text: 'Messages no longer sent to wrong chat after DM' },
      { type: 'fix',  text: 'Stay on same server & channel after page refresh' },
      { type: 'fix',  text: 'No duplicate member in member list after avatar change' },
      { type: 'fix',  text: 'Welcome message only shows for truly new members' },
      { type: 'fix',  text: 'Banned/kicked members stay removed after refresh' },
