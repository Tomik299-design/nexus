...
const CHANGELOG = [
  {
    ...
    date: '2026-03-27',
    items: [
      { type: 'new',  text: 'Voice calls via WebSocket relay — works on all networks' },
      { type: 'new',  text: 'Noise Gate — filters breathing & background noise' },
      { type: 'new',  text: 'Mic & output volume control in Audio settings' },
      { type: 'new',  text: 'Voice channel text chat (💬 button)' },
      { type: 'new',  text: 'Language switcher CS 🇨🇿 / EN 🇺🇸' },
      { type: 'new',  text: 'Persistent bans & offline members saved to disk' },
      { type: 'new',  text: 'DM list in sidebar with unread badges' },
      ...
      { type: 'fix',  text: 'Leaving voice channel now properly cleans up UI' },
      { type: 'imp',  text: 'Performance optimizations for gaming in background' },
      { type: 'imp',  text: 'Server isolation — join only via invite link' },
    ]
  }
];
